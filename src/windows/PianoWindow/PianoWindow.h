...
private:
    ...
    constexpr static int s_windowFlags = ImGuiWindowFlags_NoScrollbar | ImGuiWindowFlags_NoScrollWithMouse | ImGuiWindowFlags_NoResize | ImGuiWindowFlags_NoNav | ImGuiWindowFlags_NoCollapse | ImGuiWindowFlags_NoBackground | ImGuiWindowFlags_NoMove;
...
public:
    constexpr static Vec2<uint16_t> s_windowSize = {KEYS_WHITE * PianoKey::s_whiteSize.x, PianoKey::s_whiteSize.y};
};